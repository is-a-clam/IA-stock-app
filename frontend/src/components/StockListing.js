          ...
          >
            <Grid.Row>
              <Grid.Column width={10} style={{ padding: '0px' }}>
                <Header as='h1'>{this.state.data.companyName}</Header>
              </Grid.Column>
              <Grid.Column floated='right' width={1} style={{ padding: '0px' }} textAlign='right'>
                <Icon link name='close' size='small' onClick={() => this.setState({ extraInfo: false })} />
              </Grid.Column>
            </Grid.Row>
              ...
              <Item.Description style={{ color: 'white' }}>
                ...
                >
                  <StockListingRow columns={4}>
                    ...
                    <Grid.Column width={4}>{this.props.symbol}</Grid.Column>
                    <Grid.Column width={7}>{this.state.data.companyName}</Grid.Column>
                    <Grid.Column textAlign='right' width={1}>
                      <Icon link name='close' size='small' onClick={this.props.onDelete} />
                    </Grid.Column>
                  </StockListingRow>
                  <StockListingRow>
                    {this.state.data.quote.change > 0 ? <Icon color='green' name='arrow up' /> : <Icon color='red' name='arrow down' />}
                    {this.state.data.quote.latestPrice} ({Math.round(this.state.data.quote.changePercent * 10000) / 100}
                    %)
                  </StockListingRow>
                  <StockListingRow>Previous Close: ${this.state.data.quote.close}</StockListingRow>
                  <StockListingRow>Open: ${this.state.data.quote.open}</StockListingRow>
                  <StockListingRow>
